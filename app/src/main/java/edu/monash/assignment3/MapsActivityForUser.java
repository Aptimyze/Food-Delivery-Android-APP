...
public class MapsActivityForUser extends FragmentActivity implements OnMapReadyCallback,
        ...
        else
        {
            ...
            request.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    Current.currentRider = dataSnapshot.child(requestId).child("Rider").getValue(Rider.class);
                    double latitude = Current.currentRider.getLat();
                    double longitude = Current.currentRider.getLng();
...
//
    ...
    private void drawRoute(double lat, double lon) {
        ...
        final String url = "https://maps.googleapis.com/maps/api/directions/json?origin=" + String.valueOf(lat)+","+String.valueOf(lon)+"&destination="+ Current.currentRequest.getAddress().replace(" ","+")+"&key=AIzaSyAPUGGqIyXmv2FJXjHzE-ZMR6rIgW4yAg4";
